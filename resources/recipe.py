...
# resources 폴더 안에 만드는 파일에는, API 를 만들기 위한 클래스를 작성한다.
...
class RecipeListResource(Resource):
    ...
    def post(self) :
        ...
        try : 
            ...
            # 2.3 위의 쿼리에 매칭되는 변수를 처리해 준다. 단, 라이브러리 특성상 튜플로 만들어야 한다.
        ...
        # 3. DB에 잘 저장되었으면, 클라이언트에게 응답해준다. 보내줄정보(json) 과 http 상태코드를 리턴한다.
    ...
    def get(self) :
        ...
        try :
            ...
            # 중요!!!
            # Select 문에서!!! 커서를 만들 때는 파라미터 dictionary = True로 해준다.
            ...
            # datetime은 파이썬에서 사용하는 데이터 타입이므로, JSON 형식이 아니다.
            ...
            return {"result" : "fial", "error" : str(e)}, 500
...
class RecipeResource(Resource) :
    ...
    def get(self, recipe_id) :
        ...
        # 1. 클라이언트로부터 데이터를 받아온다.
        #    이미 경로에 들어있는 레시피 아이디를 받아왔다. 위의 recipe_id라는 변수에 이미 있다.
        ...
        # 여기서 리스트에 데이터가 있는 경우와 없는 경우로 체크하여 클라이언트에게 데이터를 보낸다.
